...
<h1 style="padding-left:0px;"><b>Outbox</b></h1>
</div>
...
$sqlget = "SELECT * FROM messages WHERE
                    sentFrom = '$name' ORDER BY dateMessage DESC ";
...
echo "<tr><th style='width:15%'>Date</th><th style='width:15%'>Sent From:</th><th style='width:15%'>Sent To:</th><th>Message:</th></tr>";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
 ...
 echo $row ['message'];
 //echo "</td><td>";
 //echo "<a href=\"delete.php?id=".$row['sentfrom']."\">Delete</a>";
 echo "</td><tr>";
}
echo "</table>";
